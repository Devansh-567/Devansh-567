...
#### Research Papers
* **IEEE:** *Delta Encoding and Predictive Modeling for Lossy Time-Series Compression Using Adaptive Linear Updates* ([Link](https://ieeexplore.ieee.org/abstract/document/11368175))
* **IEEE:** *Parallel Task Scheduling and Dynamic Offloading for Deep Learning: Aptos Framework* ([Link](https://ieeexplore.ieee.org/abstract/document/11368305))
* **IEEE:** *SMEE Architecture & Protocols* ([Link](https://ieeexplore.ieee.org/abstract/document/11367979))
* **IEEE:** *DMS4096+ Cryptographic Protocol Engine* ([Link](https://ieeexplore.ieee.org/abstract/document/11290566/))
